...
public class WalkerGenerator : MonoBehaviour
{
    ...
    void Updatepos()
    {
        for (int i = 0; i < Walkers.Count; i++)
        {
            ...
            FoundWalker.pos += FoundWalker.direction;
            FoundWalker.pos.x = Mathf.Clamp(FoundWalker.pos.x, 1, gridHandler.GetLength(0) - 2);
            FoundWalker.pos.y = Mathf.Clamp(FoundWalker.pos.y, 1, gridHandler.GetLength(1) - 2);
